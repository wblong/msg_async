...
/**
 * 
 * @ClassName: 资源数据服务Demo 
 * @Description: TODO
 * @author rmeng 
 * @date 2018年11月13日 下午2:32:35 
 *
 */
public class RSSClientTest {
	
	private static Logger logger = LoggerFactory.getLogger(RSSClientTest.class);
	
	public static void main(String[] args){
		rssClient();
	}
	
	public static void rssClient(){
		...
		try {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -5575806054158205358L;
			...
			ImfSsAutoClient ssAutoClient = ImfSsAutoClient.getImfSsAutoClient(ImfServiceType.RSS, listener);
			//取消订阅
